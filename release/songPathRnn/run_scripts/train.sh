...
dataOptions="-dataDir $data_dir -tokenFeatures $tokFeats -minibatch $batchSize -gpuid $gpu_id -learningRate $learningRate -l2 $l2 -numEpochs $numEpoch -useAdam $useAdam -numRowsToGPU 1"
